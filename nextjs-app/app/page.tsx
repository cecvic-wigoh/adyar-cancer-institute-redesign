...
export default function Home() {
  return (
    <main id="main">
      ...
      {/* EMERGENCY & LOCATIONS */}
      <section className="emergency-locations section" id="contact">
        <div className="container">
          <div className="section-header">
            <span className="section-label" style={{ background: '#FFF5F5', color: '#C53030' }}>+ Emergency & Locations</span>
            <h2>We Are Here When You Need Us</h2>
            <p>Immediate care and accessible locations across Chennai.</p>
          </div>
          
          <div className="contact-grid">
            <div className="contact-card emergency">
              <div className="contact-icon" style={{ background: '#C53030' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.23 2.18 2 2 0 012.18 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.18 6.18l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>
              </div>
              <h3>24/7 Emergency Hotline</h3>
              <p>For urgent cancer-related complications and immediate admissions.</p>
              <a href="tel:+914422209150" className="emergency-number">(044) 2220 9150</a>
              <span className="availability">Available 24 Hours / 7 Days</span>
            </div>

            <div className="contact-card">
              <div className="contact-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>
              </div>
              <h3>Main Campus (Hospital)</h3>
              <p>East Canal Bank Road, Adyar, Chennai &ndash; 600 020</p>
              <a href="https://www.google.com/maps/search/?api=1&query=Cancer+Institute+(WIA)+Adyar+Chennai" target="_blank" rel="noopener noreferrer" className="text-link">
                View on Google Maps <ArrowIcon size={14} />
              </a>
            </div>
            ...
            <div className="contact-card">
              ...
              <h3>Sardar Patel Road Campus</h3>
              <p>38, Sardar Patel Rd, Nehru Nagar, Adyar, Chennai &ndash; 600 036</p>
              <a href="https://www.google.com/maps/search/?api=1&query=38,+Sardar+Patel+Rd,+Nehru+Nagar,+Adyar,+Chennai,+Tamil+Nadu+600036" target="_blank" rel="noopener noreferrer" className="text-link">
                View on Google Maps <ArrowIcon size={14} />
              </a>
            </div>
          </div>
