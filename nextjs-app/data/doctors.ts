...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    areasOfExpertise: [
      ...
      'Paediatric and Adult Hematopoietic stem cell transplantation and management of GVHD and post transplant complications',
    ],
    about: [
      'Dr. Karthik Rengaraj is a Consultant Hemato-Oncologist and BMT Physician currently serving as Assistant Professor in Department of Medical Oncology. He completed his MBBS from Thanjavur Medical College, MD in General Medicine from Government Medical College, Nagpur, followed by advanced training in Hemato-Oncology at Tata Memorial Centre, Mumbai and DM Clinical Hematology from Christian Medical College, Vellore. He is additionally qualified with MRCP (UK) and DipRCPath (Haem), London.',
    ...
    linkedin: 'http://linkedin.com/in/dr-karthik-r-b442719b',
    metaDescription: 'Dr. Karthik Rengaraj — Assistant Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      '2017 - 2019 Chennai',
      'Faculty, Department of Medical Oncology, Cancer Institute WIA',
      '2019-present Chennai',
    ],
    linkedin: 'https://www.linkedin.com/in/parathan-karunakaran-60a1918a',
    metaDescription: 'Dr. Parathan Karunakaran — Consultant, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: 'https://www.linkedin.com/in/dr-jovita-martin-daniel-975a8310?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    metaDescription: 'Dr. Priya Jovita Mary Martin Daniel — Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      'Intern, PSG Hospitals, Coimbatore (2017 – 2018)',
    ],
    linkedin: 'https://www.linkedin.com/in/pragadeesh-thamaraiselvan-0b55a6387',
    metaDescription: 'Dr. Pragadeesh T — Assistant Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      'Associate professor , Medical Oncology, Cancer Institute(WIA) ,Adyar           (2021 - till now)',
    ],
    linkedin: 'https://linkedin.com/in/gangothri-selvarajan-associate-professor-medical-oncology-9887b5387',
    metaDescription: 'Dr. Gangothri Selvarajan — Associate Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-gargi-das',
    name: 'Dr. Gargi Das',
    ...
    areasOfExpertise: [
      ...
      'Long-term follow-up and late effects of childhood cancer',
      'Neurocognitive and metabolic complications',
      'Supportive Care in Pediatric Oncology',
      'Febrile neutropenia and severe infections',
    ],
    about: [
    ...
    linkedin: '',
    metaDescription: 'Dr. Gargi Das — Assistant Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      ...
      'Staining',
      'Culture',
      'Anti-microbial and automations',
      'Automations- Bactec, BacT Alert, Vitek 2,MALDI-TOF,Bio-fire',
      'Virology- Extraction of RNA /DNA viruses, RT –PCR.',
      'Mycobacterium-AFB staining, Culture by LJ medium, MGIT, Gene Xpert,RT -PCR',
      'Immunology/Serology-ELISA',
    ...
    experience: [
      ...
      'Parvathy Multi specialty hospital, Chennai',
      'Assistant Professor, Dept of Microbiology',
      'Vels medical College, Chennai',
      'Consultant Microbiologist, Molecular Biologist ,Safety office',
      'Medall labs Pvt Ltd, Chennai',
    ],
    linkedin: '',
    metaDescription: 'Dr. R.Packia Nancy — Assistant Professor, Microbiology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-dinesh-r',
    name: 'Dr. Dinesh R',
    ...
    experience: [
      ...
      'Assistant Professor, Medical Oncology, Kalaignar Centenary superspeciality Hospital',
    ],
    linkedin: 'https://www.linkedin.com/in/dinesh-ravikumar-a4b93614a?utm_source=share_via&utm_content=profile&utm_medium=member_android',
    metaDescription: 'Dr. Dinesh R — Assistant Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: '',
    metaDescription: 'Dr. Thuthi Mohan — Head of Department, Microbiology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: 'https://www.linkedin.com/in/nivedhyaa-srinivasaraghavan-33774b25',
    metaDescription: 'Dr. Nivedhyaa Srinivasaraghavan — Consultant, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      'Consultant , cardiac anesthesia, Vijaya hospitals, Chennai 2019-2012',
      'Assistant Professor, PSGIMSR Coimbatore, 2010-2011',
      'Consultant, Ivy hospitals, mohali, 2009',
      'Assistant Professor, Giansagar medical College, Banur, 2008',
    ],
    linkedin: '',
    metaDescription: 'Dr. Subramanian H A — Associate Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: '',
    metaDescription: 'Dr. Deepa Devi. G — Head of Department, Quality Control & Support Services at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      'Registrar, Cardiac Anaesthesia, Vijay Heart Foundation, Chennai',
      'Lecturer in Anaesthesia, MS Ramaiah Medical College, Bangalore',
      'Consultant Trauma Anaesthesiologist, HOSMAT Hospital, Bangalore',
      'Specialist Registrar, Sultan Qaboos University Hospital, Muscat, OMAN',
      'Specialist Registrar, Intensive Care, Royal Adelaide Hospital, South Australia',
    ],
    linkedin: 'https://www.linkedin.com/in/aravind-narayanan-89a1979a?utm_source=share_via&utm_content=profile&utm_medium=member_android',
    metaDescription: 'Dr. Aravind Narayanan — Associate Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-a-hariesh',
    name: 'Dr. A. Hariesh',
    ...
    experience: [
      ...
      'Assistant Professor, Department of Anesthesia, Shri Sathya Sai medical College, Chennai',
      'Assistant Professor, Department of Anaesthesia and Pain Medicine, Cancer Institute Adyar',
    ],
    linkedin: '',
    metaDescription: 'Dr. A. Hariesh — Assistant Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-nairita-das',
    name: 'Dr. Nairita Das',
    ...
    experience: [
      ...
      'MTI Fellow, Royal Victoria Infirmary NHS Trust, Newcastle upon Tyne UK.',
      'Assistant Professor, Dept of Anaesthesia, Sri Ramachandra Medical College and Research Institute',
      'Junior Resident, Dept of Anaesthesia, Kasturba Mefical College Manipal',
    ],
    linkedin: 'https://www.linkedin.com/in/ nairita-das-bb1858172',
    metaDescription: 'Dr. Nairita Das — Assistant Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-pritha-raj',
    name: 'Dr. Pritha Raj',
    ...
    experience: [
      ...
      'Junior Consultant-2019-2020 Rainbow Children Hospital,Chennai',
      'Senior Registrar- 2020-2021 SIMS HOSPITAL, Chennai',
      'Asst Professor- Cancer Institute  WIA, 2021-',
    ],
    linkedin: 'https://www.linkedin.com/in/pritha-raj-associate-professor-anaesthesia-5b91123b1?utm_source=share_via&utm_content=profile&utm_medium=member_android',
    metaDescription: 'Dr. Pritha Raj — Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      'Professor & Head from 2007 to till date',
    ],
    linkedin: '',
    metaDescription: 'Dr. N.vivekanandan — Professor & Head of Department, Radiation Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: 'https://www.linkedin.com/in/meenakshi-v-v-81298b2a8',
    metaDescription: 'Dr. Meenakshi V V — Head of Department, Palliative Medicine at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-balaji-s',
    name: 'Dr. Balaji S',
    ...
    areasOfExpertise: [
      'Skullbase surgery',
      'Neuro oncology',
      'Image guided Onco Neurosurgery',
    ],
    about: [
    ...
    experience: [
      ...
      'Assistant Professor Neurosurgery at',
      'St John\'s Hospital Bangalore',
    ],
    linkedin: 'https://www.linkedin.com/in/dr-s-balaji-mbbs-ms-ent-drnb-neuro-mba-pgdmls-ma-sanskrit-b7757b15b',
    metaDescription: 'Dr. Balaji S — Assistant Professor, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-kunal-nandy',
    name: 'Dr. Kunal Nandy',
  ...
  },
  {
    ...
    experience: [],
    linkedin: '',
    metaDescription: 'Dr. Raksha R — Consultant, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      'Musculoskeletal Oncology - Primary bone tumours',
      'metastatic bone disease',
      'soft tissue sarcoma. cutaneous malignancies',
      'Bone Bank - Procurement, Processing, Storage and distribution of Bone allografts',
    ],
    about: [
    ...
    experience: [
      ...
      'Department of Surgical Oncology, Cancer Institute (WIA), Chennai (2021–Present)',
      'In-charge, Bone Bank, Cancer Institute (WIA), Chennai (2019–Present)',
      'Assistant Professor, Orthopaedic Oncology – Cancer Institute (WIA), Chennai (2017–2021)',
      'International Clinical Fellow, Orthopaedic Oncology – Seoul National University Hospital, South Korea (2016)',
      'Lecturer, Orthopaedic Oncology – Cancer Institute (WIA), Chennai (2014–2017)',
    ],
    linkedin: 'https://www.linkedin.com/in/chandra-kumar-krishnan-b8581628b/',
    metaDescription: 'Dr. Chandra Kumar Krishnan — Associate Professor, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      'Benign bone tumors, pediatric tumors',
      'Bone, soft tissue, and skin malignancies',
      'Metastatic bone disease',
      'Complex revision surgeries',
      'Navigation-assisted tumor surgery',
      'Limb salvage techniques and tumor prosthesis designing',
      'Biological reconstruction and cryotherapy in oncology',
      'Isolated limb perfusion for extremity melanomas and sarcomas',
      'Bone banking',
    ],
    about: [
    ...
    experience: [
      ...
      'Assistant Professor in Orthopedics, SDUMC, Kolar',
      'Junior Consultant in Orthopedics, SK Hospital, Trivandrum',
    ],
    linkedin: 'https://www.linkedin.com/in/ashik-bary-753850137/',
    metaDescription: 'Dr. Ashik A Bary — Assistant Professor, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      ...
      'Robotic hysterectomy for early cervical & endometrial cancer',
      'Advanced cytoreductive surgery for ovarian cancer',
      'Secondary cytoreduction and HIPEC (platinum-sensitive ovarian cancer)',
      'Fertility-sparing oncologic surgeries (early cervical cancer',
      'germ cell tumors',
      'GTN)',
      'Sentinel lymph node mapping in endometrial cancer',
      'Management of gestational trophoblastic neoplasia (including refractory cases)',
    ...
    experience: [
      ...
      'Assistant Professor 	Gynaecological Oncology  	Cancer Institute, Chennai 	August 2012 	Apr 2018',
      'Assistant Professor	Obstetrics & Gynaecology	Chettinad Hospital and Research Insitute, Chennai 	August 2009	July 2012',
      'Private Practitioner 	Obstetrics & Gynaecology	Private Practice, Gurgoan & New  Delhi 	May 2007 	July 2009',
      'Senior Resident 	Obstetrics & Gynaecology	Lady hardinge Medical college &hospital ,',
      'New Delhi 	FEB 2004 	Feb 2007',
    ],
    linkedin: '',
    metaDescription: 'Dr. Ujwala Prakash wakpaijan — Associate Professor, Gynaecological Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      'Nephrectomy',
      'Cystectomy',
      'Penectomy with Sentinel node biopsy',
      'RPLND',
    ...
    linkedin: 'https://www.linkedin.com/in/shalini-shree-5b0427197',
    metaDescription: 'Dr. K Shalini Shree — Assistant Professor, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-jayashree-n',
    ...
    areasOfExpertise: [
      ...
      'Minimally invasive cancer surgery by advanced laparoscopy equipments/ latest  Da Vinci Xi robotic system',
      ...
      'Hystereoscopy and hysteroscopic procedures',
      'Treating precancerous condition of uterine cancers',
      'Treating precancerous conditions ( preinvasive conditions like CIN 1/2/3) of cervix with conservative approaches (LEEP/ cone biopsy)',
    ],
    about: [
    ...
    linkedin: '',
    metaDescription: 'Dr. (Maj) Jayashree N — Assistant Professor, Gynaecological Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-vnandhini',
    name: 'Dr. V.Nandhini',
    ...
    experience: [
      ...
      'MS General surgery residency 2018-2021',
      'Mch Surgical oncology residency 2022-2025',
    ],
    linkedin: 'https://www.linkedin.com/in/dr-nandhini-v-6904b7258?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    metaDescription: 'Dr. V.Nandhini — Consultant, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-amy-jose',
    name: 'Dr. Amy Jose',
    ...
    fellowships: [
      ...
      'Fellowship in hysteroscopy (Medicity)',
      'Training in basic and advanced pelvic laparoscopic surgery - June 2024 (International school of surgical anatomy- ISSA)',
    ],
    areasOfExpertise: [
      'Radical surgeries',
      '* Ovarian Cytoreductive surgeries - including extensive peritonectomy and visceral resection',
      '* Radical hysterectomy- nerve preserving',
      '* Retroperitoneal nodal dissection (pelvic, para-aortic)',
      'Minimal invasive procedures',
      '*Robotic surgery',
      '*Laparoscopic surgery',
      '*Hysteroscopy',
      'Cervical cancer preventive and screening procedures',
      '* Colposcopy',
    ],
    about: [
    ...
    experience: [
      ...
      '(WIA), Adyar, Chennai (September 2019 – Present)',
      'Postdoctoral Fellow: Department of Gynaecological Oncology, Christian Medical',
      'College, Vellore (July 2017 – June 2019)',
      'Assistant Professor: Department of Obstetrics and Gynaecology, Ponnaiyah Ramajayam Institute of Medical Sciences, Nellur, Kancheepuram (September 2016 – July 2017)',
      'Medical Officer: Department of Obstetrics & Gynaecology, Durgabhai',
    ],
    linkedin: 'https://www.linkedin.com/in/dr-amy-jose-7bb6361b2?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    metaDescription: 'Dr. Amy Jose — Assistant Professor, Gynaecological Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      ...
      'endometrial',
      'vulvar and cervical cancers',
      'Radical and fertility-preserving oncologic procedures',
      'Evidence-based treatment planning and multidisciplinary cancer care',
      'Early detection and prevention of cervical cancer',
      'Colposcopy and management of pre-invasive cervical lesions',
      'Minimally invasive and staging procedures in gynecologic oncology',
      'Survivorship care and quality-of-life optimization',
    ...
    experience: [
      ...
      'Visiting consultant- Motherhood hospital, Coimbatore',
    ],
    linkedin: 'https://www.linkedin.com/in/kavin-nilavu-loganathan-468278361',
    metaDescription: 'Dr. Kavin  Nilavu L — Consultant, Gynaecological Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-poorna-m-s',
    name: 'DR POORNA M S',
    ...
    experience: [
      ...
      'Senior resident - Department of Anaesthesiology and Pain and Palliative Care,  JSS Medical College, Mysuru. January 2019- July 2021',
      'Assistant Professor - Department of Anaesthesiology and Pain and Palliative Care, Cancer Institute(WIA), Adyar, Chennai. September 2021 – till date',
    ],
    linkedin: '',
    metaDescription: 'DR POORNA M S — Assistant Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-pavithras',
    name: 'Dr. Pavithra.S',
    ...
    areasOfExpertise: [
      ...
      'Larynx and Hypopharynx cancer surgery',
    ],
    about: [
    ...
    experience: [
      ...
      'Junior Consultant , Apollo proton cancer centre, Chennai.',
    ],
    linkedin: 'https://www.linkedin.com/in/dr-pavithra-s-0a4b08354?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    metaDescription: 'Dr. Pavithra.S — Assistant Professor, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-prasanth-s',
    name: 'Dr. Prasanth S',
    ...
    linkedin: '',
    metaDescription: 'Dr. Prasanth S — Associate Professor, Medical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    areasOfExpertise: [
      ...
      'SUPERMICROSURGERY',
      'GENERAL PLASTIC SURGRRY',
      'BURNS',
      'TRAUMA CARE',
      'MAXILLOFACIAL R3CONSTRUCTION',
    ],
    about: [
    ...
    linkedin: '',
    metaDescription: 'Dr. Diana Niranjani Raj — Consultant, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: '',
    metaDescription: 'Dr. Karthigaiselvi Murugesan — Consultant, Radiology at Cancer Institute (WIA), Chennai.',
  },
  {
  ...
  },
  {
    ...
    areasOfExpertise: [
      'General Anaesthesia',
      'Airway management',
      'Anaesthesia for emergency surgeries',
    ],
    about: [
    ...
    experience: [
      ...
      'Assistant Professor - Anaesthesiology, PSGIMS&R, Coimbatore',
      'Assistant Professor - Anaesthesiology, SRIHER, Porur, Chennai',
    ],
    linkedin: 'https://www.linkedin.com/in/kausalya-venkatesan-ba13079',
    metaDescription: 'Dr. Kausalya V — Assistant Professor, Anaesthesia & Pain Management at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-ashok-kumar',
    name: 'Dr. Ashok Kumar',
    ...
    linkedin: 'https://www.linkedin.com/in/ashok-kumar-8bb538161/',
    metaDescription: 'Dr. Ashok Kumar — Consultant, Nuclear Medicine at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    linkedin: '',
    metaDescription: 'Dr. R. Krishnakumar — Professor & Head of Department, Nuclear Medicine at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [],
    linkedin: '',
    metaDescription: 'Dr. Akshen Sundaresan — Consultant, Microbiology at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-rama-r',
    name: 'Dr. Rama R',
    ...
    experience: [
      ...
      'In-charge, Department of Dietetics.',
    ],
    linkedin: '',
    metaDescription: 'Dr. Rama R — Professor & Head of Department, Quality Control & Support Services at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-priya-iyer',
    name: 'Dr. Priya Iyer',
    ...
    linkedin: 'https://www.linkedin.com/in/dr-priya-iyer-6458b5110',
    metaDescription: 'Dr. Priya Iyer — Head of Department, Radiation Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    experience: [
      ...
      'Assistant Director, 2014-2020',
      'Associate Professor and Head, 2008-2013',
      'Assistant Professor, 2003-2008',
      'Senior Biostatistician, Cancer Institute (WIA), Chennai, 1990-2003',
    ],
    linkedin: 'https://www.linkedin.com/in/swaminathan-rajaraman-3677a050/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3ByxRkoqPoQl2jHsqHNu4Uzw%3D%3D',
    metaDescription: 'Dr. R. Swaminathan — Professor & Head of Department, Quality Control & Support Services at Cancer Institute (WIA), Chennai.',
  },
  {
    slug: 'dr-anjali-a-b',
    name: 'Dr. Anjali A B',
    ...
    fellowships: [
      ...
      'Fellowship of the Indian Association of Gastrointestinal Endosurgeons, 2023',
    ],
    areasOfExpertise: [
    ...
    linkedin: '',
    metaDescription: 'Dr. Anjali A B — Assistant Professor, Surgical Oncology at Cancer Institute (WIA), Chennai.',
  },
  {
    ...
    about: [
      'Dr. Daniel Raj Joseph Thangasamy, BDS, NFPM.,, is a dedicated palliative care physician with a strong commitment to improving the quality of life of patients with advanced and life-limiting illnesses. He currently serves as a Palliative Care Physician at Mahaveer Ashray, a unit of the Cancer Institute (WIA), Chennai, where he is actively involved in symptom management, end-of-life care, communication, and holistic support for patients and families.',
...
export function getDoctorsByDepartment(deptSlug: string): Doctor[] {
  return doctors.filter(d => d.department.slug === deptSlug);
}
