    ...
    <div className="top-bar" role="complementary" aria-label="Site information">
      <div className="container">
        ...
        <div className="top-bar-emergency" aria-label="Emergency Helplines">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="emergency-icon" aria-hidden="true">
            <path d="M7 18v-6a5 5 0 1 1 10 0v6"/><path d="M5 21a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-1a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2z"/><path d="M21 12h1"/><path d="M18.5 4.5 20 6"/><path d="M12 2v1"/><path d="M4 6 5.5 4.5"/><path d="M2 12h1"/>
          </svg>
        ...
        <div className="top-bar-right">
          <div className="top-bar-social" aria-label="Social media links">
            ...
            <a href="#" className="social-icon" aria-label="Subscribe on YouTube">
